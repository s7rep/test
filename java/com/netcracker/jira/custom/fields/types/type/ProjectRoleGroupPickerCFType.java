...
/**
 * Created by vlzo0513 on 2017-07-19.
 */
public class ProjectRoleGroupPickerCFType extends AbstractProjectRoleGroupPickerCFType {

    @Autowired
    public ProjectRoleGroupPickerCFType(@ComponentImport CustomFieldValuePersister customFieldValuePersister,
    ...
    public Map<String, Object> getVelocityParameters(Issue issue, CustomField field, FieldLayoutItem fieldLayoutItem) {
        ...
        fillParametersMap(issue, field, params, true);
        return params;
    }
}

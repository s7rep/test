...
public class ViewChangeCFEventConfiguration extends AbstractChangeCFEventConfiguration {

    @Autowired
    public ViewChangeCFEventConfiguration(ChangeCFEventConfigurationManager changeCFEventConfigurationManager) {
